...
"""
A Python script to merge all .py files from a directory 
...
# The directory where your scripts were downloaded
SCRIPT_DIR = "python_scripts"

# The name of the final merged file
MERGED_FILE = "merged_concrete_examples.txt"
...
# ==============================================================================
        ...
        print("Please make sure this script is in the same folder as the 'python_scripts' directory.")
    except Exception as e:
