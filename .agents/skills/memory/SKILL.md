...
- **Common pitfalls** — bugs encountered and their fixes
- **Run commands** — exact CLI commands to execute

## Current Skills in This Project

| Skill | Path | Purpose |
| --- | --- | --- |
| `structural_analysis_selection` | `.agents/skills/structural_analysis/SKILL.md` | Structural simulation pipeline using anastruct + AISC database |
