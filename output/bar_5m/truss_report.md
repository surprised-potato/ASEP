# Modified Truss & CHB Gable Structure - Project: bar_5m

## 1. Global Building Parameters
- **Building Span:** `20.0 m`
- **Total Bays:** `4 bays` @ `5.0 m` spacing (Total Length: `20.0m`)
- **Main Steel Frames:** `3 Interior Trusses` (5.0m Tributary Width)
- **Gable Ends:** `2 Reinforced CHB Walls` (Bearing 2.5m Tributary Width)
...
| --- | --- | --- | --- | --- |
| Chords | `WT4X14` | 14.0 | 4.12 | 0.98 |
| Webs | `2L2X2X3/16` | 4.9 | 1.44 | 0.95 |

- **Total Building Steel Weight (3 Trusses):** `3,287.4 kg`
- **Estimated Steel Material Cost:** `PHP 213,677.92` (@ PHP 65/kg)
*(Note: Cost excludes the front & rear concrete gable walls)*

## 3. Global Steel Truss Cutting List (3 Trusses)
| Component | Shape | L per Piece (m) | Qty per Truss | Total Building Qty | Total Length (m) |
| --- | --- | --- | --- | --- | --- |
| Top/Bot Chords | `WT4X14` | 1.451 | 28 | 84 | 121.85 |
| Vertical Webs | `2L2X2X3/16` | 0.812 | 15 | 45 | 36.56 |
| Diagonal Webs | `2L2X2X3/16` | 1.643 | 14 | 42 | 69.02 |
...
## 6. 3D Bracing Requirements (3-Truss System)
To ensure global stability out-of-plane for the 4-bay building, the following bracing is required:
...
- **Longitudinal Roof X-Bracing:** `16mm \phi` sag rods spanning across the roof plane in the 1st and 4th bays (adjacent to the stiff CHB gable walls).
- **Sidewall Vertical X-Bracing:** `20mm \phi` rods or `L2X2X1/4` angles in the 1st and 4th wall bays to transfer longitudinal shear.
