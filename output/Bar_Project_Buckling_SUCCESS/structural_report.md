...
| Truss Self-Weight | `0.303 kN/m` (648.2 kg / 24m) |
| **Total Dead Load (D)** | **`3.303 kN/m`** |
...
| Seismic Weight ($W$) | `69.36 kN` |
| Base Shear ($V = C_s \times W$) | **`13.87 kN`** |
| Lateral q per exterior column ($V / 4 / h$) | `0.58 kN/m` |
...
| --- | --- | --- | --- | --- |
| Top Chord | -66.50 | -51.73 | -27.11 | **-66.50** |
| Bottom Chord | 62.97 | 49.63 | 31.02 | **62.97** |
| Vertical Webs | -53.73 | -41.80 | -21.90 | **-53.73** |
| Diagonal Webs | 42.67 | 33.19 | 17.39 | **42.67** |
| Exterior Columns | 21.82 | 16.97 | 8.89 | **21.82** |
| Interior Columns | 84.25 | 65.53 | 34.34 | **84.25** |

### Support Reactions per Load Case

| Reaction | LC1 — Gravity Only | LC2 — Gravity + EQ | LC3 — Gravity + Wind | **Governing** |
| --- | --- | --- | --- | --- |
| Vertical ($F_y$) — Max | 84.25 | 65.53 | 34.34 | **84.25** |
| Vertical ($F_y$) — Exterior | 21.82 | 16.97 | 8.89 | **21.82** |
| Vertical ($F_y$) — Interior | 84.25 | 65.53 | 34.34 | **84.25** |
| Horizontal ($F_x$) — Max | 0.28 | 2.91 | 23.50 | **23.50** |

> **Governing Vertical Reaction (Exterior):** `21.82 kN`
> **Governing Vertical Reaction (Interior):** `84.25 kN`
> **Governing Horizontal Reaction:** `23.50 kN` ()

## 4. Deflection Check

- **Max Deflection:** `15.63 mm`
- **Deflection Ratio (L/d):** `1344` (Target > 240) ✅ PASS

## 5. Optimized Member Selection (Governing Forces)

| Group | Selected Shape | Weight (plf) | KL/r | Gov. Force (kN) | Capacity (kN) | Governing LC |
| --- | --- | --- | --- | --- | --- | --- |
| Bottom Chord | `2L2X2X1/8` | 3.3 | 63.5 | 62.97 | 141.53 | Gravity Only |
| Vertical Webs | `HSS2.875X0.125` | 3.7 | 121.0 | -53.73 | 67.33 | Gravity Only |
| Diagonal Webs | `HSS1-1/2X1-1/2X1/8` | 2.2 | 223.5 | 42.67 | 87.63 | Gravity Only |
| Exterior Columns | `W6X15` | 15.0 | 162.9 | 21.82 | 167.74 | Gravity Only |
| Interior Columns | `W6X15` | 15.0 | 162.9 | 84.25 | 167.74 | Gravity Only |

- **Total Steel Weight:** `648.2 kg`
- **Estimated Steel Cost:** `PHP 38,894.37` (@ PHP 60/kg)
...
**Column:** `W6X15`, Height: `6.00 m`, $P_u$ = `21.82 kN`
...
| Thickness ($t_p$) | `10 mm` |
| Bearing Stress | `0.34 MPa` ≤ `11.60 MPa` (✅) |
...
| Bearing Pressure | `14.5 kPa` ≤ `100 kPa` ✅ |
| Bottom Rebar | `12mm Ø @ 200mm O.C.` (Both Ways) |


### Interior Column Foundation (×2)

**Column:** `W6X15`, Height: `6.00 m`, $P_u$ = `84.25 kN`
...
| Base Plate (B × N) | `252 mm × 252 mm` |
| Thickness ($t_p$) | `10 mm` |
| Bearing Stress | `1.33 MPa` ≤ `11.60 MPa` (✅) |
| Anchor Bolts | `4 — 16mm Ø` |
...
| --- | --- |
| Dimensions | `1.0 m × 1.0 m × 0.30 m` |
| Bearing Pressure | `56.2 kPa` ≤ `100 kPa` ✅ |
| Bottom Rebar | `12mm Ø @ 200mm O.C.` (Both Ways) |
