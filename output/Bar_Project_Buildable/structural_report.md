...
| Truss Self-Weight | `0.345 kN/m` (738.5 kg / 24m) |
| **Total Dead Load (D)** | **`3.345 kN/m`** |
...
| Seismic Weight ($W$) | `70.24 kN` |
| Base Shear ($V = C_s \times W$) | **`14.05 kN`** |
...
| --- | --- | --- | --- | --- |
| Top Chord | -70.61 | -55.16 | -30.27 | **-30.27** |
| Bottom Chord | 66.28 | 51.59 | 31.05 | **66.28** |
| Vertical Webs | -52.35 | -40.91 | -22.56 | **-22.56** |
| Diagonal Webs | 41.27 | 32.27 | 17.98 | **41.27** |
| Exterior Columns | 24.10 | 18.81 | 10.24 | **24.10** |
| Interior Columns | 82.84 | 64.66 | 35.08 | **82.84** |

### Support Reactions per Load Case

| Reaction | LC1 — Gravity Only | LC2 — Gravity + EQ | LC3 — Gravity + Wind | **Governing** |
| --- | --- | --- | --- | --- |
| Vertical ($F_y$) — Max | 82.84 | 64.66 | 35.08 | **82.84** |
| Vertical ($F_y$) — Exterior | 24.10 | 18.81 | 10.24 | **24.10** |
| Vertical ($F_y$) — Interior | 82.84 | 64.66 | 35.08 | **82.84** |
| Horizontal ($F_x$) — Max | 0.27 | 3.06 | 23.55 | **23.55** |

> **Governing Vertical Reaction (Exterior):** `24.10 kN`
> **Governing Vertical Reaction (Interior):** `82.84 kN`
> **Governing Horizontal Reaction:** `23.55 kN` ()

## 4. Deflection Check

- **Max Deflection:** `0.01 mm`
- **Deflection Ratio (L/d):** `3507626` (Target > 240) ✅ PASS

## 5. Optimized Member Selection (Governing Forces)

| Group | Selected Shape | Weight (plf) | KL/r | Gov. Force (kN) | Capacity (kN) | Governing LC |
| --- | --- | --- | --- | --- | --- | --- |
| Top Chord | `2L2X2X1/8` | 3.3 | 66.0 | -30.27 | 112.49 | Gravity Only |
| Bottom Chord | `2L2X2X1/8` | 3.3 | 63.5 | 66.28 | 141.53 | Gravity Only |
| Vertical Webs | `HSS2-1/4X2-1/4X1/8` | 3.5 | 136.9 | -22.56 | 51.29 | Gravity Only |
| Diagonal Webs | `HSS1-1/2X1-1/2X1/8` | 2.2 | 223.5 | 41.27 | 87.63 | Gravity Only |
| Exterior Columns | `W6X15` | 15.0 | 162.9 | 24.10 | 167.74 | Gravity Only |
| Interior Columns | `W6X15` | 15.0 | 162.9 | 82.84 | 167.74 | Gravity Only |

- **Total Steel Weight:** `738.5 kg`
- **Estimated Steel Cost:** `PHP 44,311.86` (@ PHP 60/kg)
...
**Column:** `W6X15`, Height: `6.00 m`, $P_u$ = `24.10 kN`
...
| Bearing Pressure | `16.1 kPa` ≤ `100 kPa` ✅ |
| Bottom Rebar | `12mm Ø @ 200mm O.C.` (Both Ways) |


### Interior Column Foundation (×2)

**Column:** `W6X15`, Height: `6.00 m`, $P_u$ = `82.84 kN`
